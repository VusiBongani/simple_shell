 ...
 * @num: representation of the number field
 ...
 *@readfd: reads the fd
 *@histcount: the line number count
 */
...
/**
 *struct builtin - has a built in string and the function
 *@type: represents the command flag
 *@func: representation of the function
 */
